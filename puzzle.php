    ...
    <div class="content">
        <div class="center">
			...
			<div class="box">
				...
				<?php
					if(isset($_GET['userAnswer1']) && isset($_GET['userAnswer2']) && sset($_GET['userAnswer2'])){
						$userAnswer = $_GET['userAnswer1'];
						$score = 0;
						if ($userAnswer=="сон" || $userAnswer=="сновидение"){$score++;}

						$userAnswer = $_GET['userAnswer2'];
						if ($userAnswer=="морской" || $userAnswer=="укус акулы"){$score++;}

						$userAnswer = $_GET['userAnswer3'];
						if ($userAnswer=="шахматный" || $userAnswer=="мертвый"){$score++;}
